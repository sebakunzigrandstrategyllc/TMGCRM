  ...
  return (
    <Modal open={open} onClose={onClose} title="Intake Documents" wide>
      <p className="mb-3 text-xs text-gray-500">
        Everything here feeds See's AI draft, and cascades downstream from there. PDF and plain-text files are read
        in full; other file types (audio/video, images) are stored as attachments only — there's no local
        transcription or document conversion yet.
      </p>
